            ...
            else if (mode == NestedRuleExecutionMode.Performance)
            {
                Assert.All(andResults,
                    c => {
                        ...
                        Assert.True(c.ChildResults.Take(c.ChildResults.Count() - 1).All(d => d.IsSuccess == true));
                    });
                ...
                Assert.All(orResults,
                    c => {
                        ...
                        Assert.True(c.ChildResults.Take(c.ChildResults.Count() - 1).All(d => d.IsSuccess == false));
                    });
